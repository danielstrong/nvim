return {
    {
        ...
        keys = (function()
            ...
            return {
                ...
                { "<localleader>nH", "<cmd>FzfLua command_history<cr>", desc = "Fzf Command History" },
                { '<localleader>n"', "<cmd>FzfLua registers<cr>", desc = "Fzf Registers" },
                { "<localleader>n;", "<cmd>FzfLua commands<cr>", desc = "Fzf Commands" },
                { "<localleader>n:", "<cmd>FzfLua builtin<cr>", desc = "Fzf Builtin" },
