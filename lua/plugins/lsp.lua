            ...
            servers = {
                ["*"] = {
                    keys = {
                        ...
                        { "<localleader>kd", vim.lsp.buf.definition, desc = "Goto Definition", has = "definition" },
                        { "<localleader>kr", vim.lsp.buf.references, desc = "References" },
                        { "<localleader>kI", vim.lsp.buf.implementation, desc = "Goto Implementation" },
                        { "<localleader>ky", vim.lsp.buf.type_definition, desc = "Goto Type Definition" },
                        { "<localleader>kD", vim.lsp.buf.declaration, desc = "Goto Declaration" },
