    ...
    },
    {
        ...
        keys = {
            ...
            },
            {
                "<localleader>gE",
                function()
                    require("custom-utils.zdiff_buffer").toggle("main")
                end,
                desc = "Zdiff (main)",
            },
        },
    },
    {
        ...
        opts = {
            ...
            terminal = {
                ...
                win = {
                    wo = {
                        winhighlight = "Normal:NormalDark,NormalNC:NormalDark",
                    },
                },
            },
        ...
        keys = {
            ...
            -- +------------------------------------+---------------------------------------+-----------------------------------------------+
            -- stylua: ignore start
            { "<localleader>fB", function() Snacks.picker.git_grep() end, desc = "fuzzy get_grep", },
            ...
            { "<localleader>fR", function() Snacks.picker.git_files() end, desc = "fuzzy git files", },
