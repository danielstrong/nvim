return {
    { "folke/persistence.nvim", enabled = false },
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<localleader>sQ", "<cmd>AutoSession save<CR><cmd>q<cr>", { desc = "Save Session + Quit" })
            vim.keymap.set("n", "<localleader>sQA", "<cmd>AutoSession save<CR><cmd>qa<cr>", { desc = "Save Session + Quit all" })
            vim.keymap.set("n", "<localleader>sWQA", "<cmd>AutoSession save<CR><cmd>wqa<cr>", { desc = "Save Session + Save Quit all" })
            vim.keymap.set("n", "<localleader>sWQ", "<cmd>AutoSession save<CR><cmd>wq<cr>", { desc = "Save Session + Save Quit" })
            vim.keymap.set("n", "<localleader>sWW", "<cmd>AutoSession save<CR><cmd>w<cr>", { desc = "Save Session + Save" })
            vim.keymap.set("n", "<localleader>sWA", "<cmd>AutoSession save<CR><cmd>wa<cr>", { desc = "Save Session + Save all" })
            vim.keymap.set("n", "<localleader>sw", "<cmd>AutoSession save<CR>", { desc = "Save Session" })
            vim.keymap.set("n", "<localleader>sEw", "<cmd>AutoSession save ", { desc = "Save Session with name" })
            vim.keymap.set("n", "<localleader>sr", "<cmd>AutoSession restore<CR>", { desc = "Restore Session" })
            vim.keymap.set("n", "<localleader>sEr", "<cmd>AutoSession restore ", { desc = "Restore Session with name" })
            vim.keymap.set("n", "<localleader>se", "<cmd>AutoSession search<CR>", { desc = "Search Session" })
            vim.keymap.set("n", "<localleader>sd", "<cmd>AutoSession deletePicker<CR>", { desc = "Delete Session Picker" })
            vim.keymap.set("n", "<localleader>sx", "<cmd>AutoSession delete<CR>", { desc = "Delete Session" })
            vim.keymap.set("n", "<localleader>sEx", "<cmd>AutoSession delete ", { desc = "Delete Session with name" })
            vim.keymap.set("n", "<localleader>sD", "<cmd>AutoSession purgeOrphaned<CR>", { desc = "Purge Orphaned Session" })
            vim.keymap.set("n", "<localleader>st", "<cmd>AutoSession enable<CR>", { desc = "Enable Autosave Session" })
            vim.keymap.set("n", "<localleader>sT", "<cmd>AutoSession disable<CR>", { desc = "Disable Autosave Session" })
        end,
    },
}
